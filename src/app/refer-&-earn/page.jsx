...
const ReferAndEarn = () => {
  ...
  const copy = async () => {
    ...
    setShow(true);
    await navigator.clipboard.writeText("dge765rtgdhb");
  };
  return (
    <>
        ...
        <div className="flex flex-col items-center gap-3">
              ...
              <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">devanshupadhyay@gmail.com</td>
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">chiragbum@gmail.com</td>
                    <td class="px-6 py-4 text-blue-700">Registered</td>
                  </tr>
                  <tr class="bg-white dark:bg-gray-800">
                    ...
                    <td class="px-6 py-4">deepaksharma@gmail.com</td>
                    <td class="px-6 py-4 text-orange-600">Verified</td>
                  </tr>
                </tbody>
              </table>
            </div>
          ...
          >
            <div className="flex flex-col  p-[20px] gap-3">
              ...
              <p>
                {" "}
                These Terms and Conditions (the "Terms") outline the guidelines
                for participating in the Haco Referral Program. By taking part
                in this Referral Program, you agree to adhere to these Terms.
                Kindly review these Terms thoroughly before participating.
              </p>
              <div>
                <ol class="space-y-4 text-gray-800 list-decimal list-inside ">
                  <li>
                    ...
                    <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
                      ...
                      <li>
                        Referrers must have an active account on Haco to qualify
                        for earning referral rewards.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
                      <li>
                        ...
                        referral code ("Referral Code") from Haco. This code can
                        be shared with potential Referees.
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
                      <li>
                        ...
                        Code, the Referee will receive a reward of $20 directly
                        credited to their Haco account.
                      </li>
                      <li>
                        {" "}
                  ...
                  <li>
                    ...
                    <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
                      ...
                      <li>
                        The Haco system will automatically apply earned referral
                        rewards to the Referrer's account, reducing the total
                        purchase amount during checkout.
                      </li>
                    </ul>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
                      ...
                      <li>
                        R In the event of program termination, referral rewards
                        that have been earned but not used will become void.
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul class="pl-5 mt-2 space-y-1 list-disc list-inside">
                      <li>
                        ...
                        glitches, delays, or interruptions that may occur during
              ...
              <p>
                {" "}
                By participating in the Haco Referral Program, you signify your
                acceptance of these Terms and Conditions. These Terms are
                subject to change without notice, with the most current version
                available on the Haco platform.
              </p>
            </div>
