    ...
    <>
      <footer className="bg-white dark:bg-gray-900">
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div
            className="flex flex-col gap-2 lg:flex-row  justify-between w-full"
            // style={{ border: "2px solid blue" }}
          >
            <div
              className="mb-6 md:mb-0 lg:w-[35%] flex flex-col gap-3 "
            ...
            <div
              className="grid grid-cols-2 lg:w-[60%] gap-8 sm:grid-cols-3"
